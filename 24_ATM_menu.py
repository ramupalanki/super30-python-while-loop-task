# Initialization: set the starting account balance before the loop begins.
balance = 10000

# Condition: while True keeps the ATM menu running repeatedly.
# Termination: the loop ends when the user chooses option 4 and break is executed.
while True:
    print("\nATM Menu")
    ...
    # checking the choice is 2 and performing deposit
        ...
        if amount > 0:
            ...
            # checking if the amount is less than or equal to 0 and displaying invalid amount
